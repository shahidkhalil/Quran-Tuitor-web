...
export default async function ParentSupportPage({ searchParams }: Props) {
  ...
  return (
    <div>
      <PanelPageHeader
        eyebrow="Help"
        title="Support"
        description="Open a case from a trial or paid lesson. We respond in-platform — never pay tutors directly."
        actions={
      ...
      <SupportCaseList cases={cases} newHref="/parent/support/new" />
    </div>
  );
}
